...
describe("File System Functions", () => {
  ...
  describe("ensureDirExists", () => {
    it("should create the directory if it doesn't exist", async () => {
      ...
      expect(FileSystem.makeDirectoryAsync).toHaveBeenCalledWith(testDir, {
        intermediates: true,
      });
    });
  ...
  describe("cacheFile", () => {
    it("should save a blob to the file system successfully", async () => {
      ...
      await expect(cacheFile(blob as Blob, testFileUri)).resolves.toEqual(
        testFileUri
      );
    ...
    it("should handle FileReader error", async () => {
      const blob = "error";
      await expect(
        cacheFile(blob as unknown as Blob, testFileUri)
  ...
  describe("clearFiles", () => {
    ...
    it("should handle errors during deletion", async () => {
      ...
      await expect(clearFiles(fileUris)).rejects.toThrow(
        "Failed to clear files: Deletion error"
      );
    });
